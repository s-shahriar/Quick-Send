...
import EmployeeRequestedView from "../../Components/EmployeeRequestedView";
...
const RequestedAssets = () => {
  ...
  useEffect(() => {
    document.title = "Requested Assets List";
  }, []);
    ...
    <div className="bg-primary px-8">
      ...
      <div className="text-center mb-5">
        <p className="text-xl font-bold text-white">
          Total Assets Requests So far: {filteredData.length}
        </p>
      </div>
      <div className="py-4">
        <EmployeeRequestedView
          data={sortedData}
          refetch={refetch}
