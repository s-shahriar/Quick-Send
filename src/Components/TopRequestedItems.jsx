...
const TopRequestedItems = ({ data }) => {
    ...
    <div className="container p-2 mx-auto sm:p-4 text-gray-800">
      <div className="overflow-x-auto">
        <table className="min-w-full text-xs">
          ...
          <tbody>
            {data.map((item) => (
              <tr key={item.assetName} className="border-b border-opacity-20 border-gray-300 bg-gray-50 text-center">
  ...
  return (
    <div className="my-4">
      <h1 className="text-4xl font-bold text-center text-teal-500 my-4">Top Most Requested Items</h1>
      {isEmpty ? (
